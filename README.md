...
### В настоящее время пополняю знания по автоматизации тестирования на java 
 [Функция расчета стоимости доставки, покрытие юнит-тестами, отчет Allure, Jacoco](https://github.com/PershikovaEP/Calculate-Delivery---function-and-unit-tests)
